...
library(pacman)
pacman::p_load(here,thematic,lubridate,dplyr,tidyr,stringr,ggplot2,ggforce,forcats,sp,sf,rgeos,geoR,rgdal,tidyr,stars,devtools,leaflet,leaflet.extras,jsonlite,RColorBrewer,viridis,forcats,scales,flexdashboard,fontawesome,rprojroot,ggthemes,plotly,spacetime,gstat)
